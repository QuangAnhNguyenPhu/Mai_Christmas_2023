...
$(document).ready(function () {
  var $card = $(".card"),
    ...
    let textTitle = "Gửi Mai !!!";
    let charArrTitle = textTitle.split('');
let text = "Hôm nay là ngày 24/12. Anh chúc cho cô gái của anh có một ngày lễ Noel thật vui vẻ và hạnh phúc, chúc cho những điều tốt đẹp sẽ đến với em. Và cũng thật xin lỗi em vì ngày này anh không thể ở bên em dành tặng cho em những điều tốt đẹp nhất. Xin lỗi vì đã để em thiệt thòi rùi. P/s: Cộng điểm nhớ!! :)))))))"
